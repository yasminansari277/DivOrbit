...
- **Custom Orbiting Submit Button**: An elegant form submission interaction in the Contact section where the send action morphs into a circular loading state and orbits a paper plane indicator.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yasminansari277/DivOrbit.git
   cd DivOrbit
   ```
...
Compile the production-ready client and server assets:
```bash
npm run build
```
...
## 👥 Co-Founders & Engineering Team

DevOrbit is co-founded by two direct contributors who engineer every line of code:

- **Yasmin Ansari** — *Frontend Engineering* · [GitHub](https://github.com/yasminansari277)
- **Ali** — *Backend Engineering* · [GitHub](https://github.com/developer-ali16)
